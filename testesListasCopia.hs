...
testsMeuLast = TestList [testMeuLastVazia, testMeuLastUmElemento, testMeuLastImpar,
 testMeuLastPar, testMeuLastZeros, testMeuLastRepetidos]
...
testsPenultimo = TestList [testPenultimoVazia, testPenultimoImpar,
 testPenultimoPar, testPenultimoZeros, testPenultimoRepetidos]
...
testsElementAt = TestList [testElementAtUmElemento, testElementAtImpar,
 testElementAtPar, testElementAtZeros, testElementAtRepetidos]
...
testsMeuReverso = TestList [testMeuReversoUmElemento, testMeuReversoImpar,
 testMeuReversoPar, testMeuReversoNegativo, testMeuReversoZeros, testMeuReversoRepetidos]

--testIsPalindromeVazia = TestCase (assertEqual "testIsPalindromeVazia" True ((ListasSolucao.isPalindrome [])) )
...
testsIsPalindrome = TestList [testIsPalindromeUmElemento, testIsPalindromeImpar,
...
testsCompress = TestList [testCompressUmElemento, testCompressImpar,
 testCompressPar, testCompressNegativo, testCompressZeros, testCompressRepetidos]

--testCompactVazia = TestCase (assertEqual "testCompactVazia" [] (ListasSolucao.compact []) )
...
testsCompact = TestList [testCompactUmElemento, testCompactImpar,
 testCompactPar, testCompactNegativo, testCompactZeros, testCompactRepetidos]

{-testEncodeVazia = TestCase (assertEqual "testEncodeVazia" [] (ListasSolucao.encode []))-}
...
testsEncode = TestList [testEncodeUmElemento, testEncodeImpar,
 testEncodePar, testEncodeZeros, testEncodeRepetidos]

--testSplitVazia = TestCase (assertEqual "testSplitVazia" [] ((ListasSolucao.split [] 0)) )
...
testsSplit = TestList [testSplitUmElemento, testSplitImpar,
...
testsInsertAt = TestList [testInsertAtVazia, testInsertAtUmElemento, testInsertAtImpar,
 testInsertAtPar, testInsertAtZeros, testInsertAtRepetidos]
...
testsMinList = TestList [testMinListUmElemento, testMinListImpar,
 testMinListPar, testMinListZeros, testMinListRepetidos]
...
testsMaxList = TestList [testMaxListVazia, testMaxListUmElemento, testMaxListImpar,
 testMaxListPar, testMaxListZeros, testMaxListRepetidos]
...
testsMySum = TestList [testMySumUmElemento, testMySumImpar,
 testMySumPar, testMySumZeros, testMySumRepetidos]
...
testsBuildPalindrome = TestList [testBuildPalindromeUmElemento, testBuildPalindromeImpar,
 testBuildPalindromePar, testBuildPalindromeZeros, testBuildPalindromeRepetidos]
...
testsMean = TestList [testMeanVazia, testMeanUmElemento, testMeanImpar,
 testMeanPar, testMeanZeros, testMeanRepetidos]
