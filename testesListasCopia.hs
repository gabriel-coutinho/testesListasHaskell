...
testIsPalindromeImparEqual = TestCase (assertEqual "testIsPalindromeImpar" True (isPalindrome [13, 25, 13]) )
testIsPalindromePar = TestCase (assertEqual "testIsPalindromePar" False (isPalindrome [13, 2, 8, 12]) )
testIsPalindromeParEqual = TestCase (assertEqual "testIsPalindromePar" True (isPalindrome [12, 3, 3, 12]) )
testIsPalindromeNegativo = TestCase (assertEqual "testIsPalindromeNegativo" Faalse (isPalindrome [-5, -3, -8]) )
testIsPalindromeNegativoEqual = TestCase (assertEqual "testIsPalindromeNegativo" True (isPalindrome [-1, -3, -1]) )
...
testEncodeVazia = TestCase (assertEqual "testEncodeVazia" [] (encode []))
testEncodeUmElemento = TestCase (assertEqual "testEncodeUmElemento" [(5,1)] (encode [5]))
testEncodeImpar = TestCase (assertEqual "testEncodeImpar" [(3,2),(25,1)] (encode [3, 25, 3]))
testEncodePar = TestCase (assertEqual "testEncodePar" [(13,1), (12,2), (8,1)] (encode [13, 12, 8, 12]))
testEncodeNegativo = TestCase (assertEqual "testEncodeNegativo" [(-5,1) (-3,1), (-8,1)] (encode [-5, -3, -8]))
testEncodeZeros = TestCase (assertEqual "testEncodeZeros" [(0,4)] (encode [0, 0, 0, 0]))
testEncodeRepetidos = TestCase (assertEqual "testEncodeRepetidos" [(2,3)] (encode [2, 2, 2]))
...
testSplitVazia = TestCase (assertEqual "testSplitVazia" [] (split [] 0) )
testSplitUmElemento = TestCase (assertEqual "testSplitUmElemento" [[5]] (split [5] 1))
{- testar split maior-}
testSplitImpar = TestCase (assertEqual "testSplitImpar" [[3, 25],[3]] (split [3, 25, 3] 1))
testSplitPar = TestCase (assertEqual "testSplitPar" [[13, 12],[8, 12]] (split [13, 12, 8, 12] 2))
testSplitNegativo = TestCase (assertEqual "testSplitNegativo" [[-5, -3, -8]] (split [-5, -3, -8] 3))
testSplitZeros = TestCase (assertEqual "testSplitZeros" [[0],[0, 0, 0]] (split [0, 0, 0, 0] 1))
testSplitRepetidos = TestCase (assertEqual "testSplitRepetidos" [[2, 2],[2]] (split [2, 2, 2] 2))
...
testSliceVazia = TestCase (assertEqual "testSliceVazia" [] (slice [] 0) )
...
testsSlice = TestList [testSliceVazia, testSliceUmElemento, testSliceImpar,
...
testInsertAtRepetidos = TestCase (assertEqual "testInsertAtRepetidos" [2, 2, 2, 2, 2] (insertAt [2, 2, 2, 2] 2 4) )
...
testMinListVazia = TestCase (assertEqual "testMinListVazia" [] (minList []) )
testMinListUmElemento = TestCase (assertEqual "testMinListUmElemento" [5] (minList [5]) )
testMinListImpar = TestCase (assertEqual "testMinListImpar" [3, 13, 25] (minList [13, 25, 3]) )
testMinListPar = TestCase (assertEqual "testMinListPar" [2, 8, 12, 13] (minList [13, 2, 8, 12]) )
testMinListNegativo = TestCase (assertEqual "testMinListNegativo" [-8, -5, -3] (minList [-5, -3, -8]) )
testMinListZeros = TestCase (assertEqual "testMinListZeros" [0, 0, 0, 0] (minList [0, 0, 0, 0]) )
testMinListRepetidos = TestCase (assertEqual "testMinListRepetidos" [2, 2, 2] (minList [2, 2, 2]) )
...
testMySumVazia = TestCase (assertEqual "testMySumVazia" [] (mySum []) )
...
testBuildPalindromeVazia = TestCase (assertEqual "testBuildPalindromeVazia" [] (buildPalindrome []) )
...
testMeanNegativo = TestCase (assertEqual "testMeanNegativo" -5.3 (mean [-5, -3, -8]) )
...
testMyAppendVazia = TestCase (assertEqual "testMyAppendVazia" [] (myAppend [] []) )
...
testsMyAppend = TestList [testMyAppendVazia, testMyAppendUmElemento, testMyAppendImpar,
